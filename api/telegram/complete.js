...
export default function handler(req, res) {
  ...
  const appUrl = process.env.MT_POKER_APP_URL || process.env.APP_URL || 'https://poker-stars-wheat.vercel.app';
  ...
  res.status(200).json({
    ok: true,
    loginUrl,
    message: '✅ MT Poker linked! Tap the button below to finish sign-in.',
    user
  });
}